...
function App() {
  ...
  return (
    ...
    <BrowserRouter>
    <TokenProvider>
    <header className='headerContent '> {/* Contiene el navbar */}
      <NavBar/>
     ...
     <Routes>
      ...
      <Route path='/register' element={<Register/>}/> {/* Direcciona al form de registro(completado) */}
      <Route path='/login' element={<Login/>}/>{/* Direcciona al form de login (completado) */}
    </Routes>
     </main>
